...
public class QuizEchoClient {
	...
	public static void main(String[] args) {
		...
		// 2. == Socket sock 을 사용하여 서버에게 데이터를 보내는(출력)연결통로인 출력스트림 생성하기  
			...
			//BufferedReader -> 2byte 기반, InputStreamReader-> 2byte 기반 System.in -> 1byte 기반
			//DataInputStream BufferedReader = new DataInputStream(System.in);-> 키보드에서 안먹는다.			
